...
public final class DNSConstants {
    ...
    public static final int    QUERY_WAIT_INTERVAL            = 25;                                                          // milliseconds between query loops.
    public static final int    PROBE_WAIT_INTERVAL            = 50;                                                          // milliseconds between probe loops.
    public static final int    RESPONSE_MIN_WAIT_INTERVAL     = 20;                                                           // minimal wait interval for response.
    public static final int    RESPONSE_MAX_WAIT_INTERVAL     = 35;                                                          // maximal wait interval for response
    public static final int    PROBE_CONFLICT_INTERVAL        = 200;                                                         // milliseconds to wait after conflict.
    ...
    public static final int    ANNOUNCE_WAIT_INTERVAL         = 100;                                                         // milliseconds between Announce loops.
    public static final int    RECORD_REAPER_INTERVAL         = 1000;                                                        // milliseconds between cache cleanups.
